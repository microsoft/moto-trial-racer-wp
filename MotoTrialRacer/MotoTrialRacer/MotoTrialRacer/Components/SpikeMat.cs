...
{
    /// <summary>
    /// This class defines the level component for the spike mat.
    /// Derives from LevelComponent.
    /// </summary>
    class SpikeMat : LevelComponent
    {
        /// <summary>
        /// Creates a new spike mat component
        /// </summary>
        ...
        public SpikeMat(World world, ContentManager content,
                        Vector2 pos, float angle, float width, float height) :
